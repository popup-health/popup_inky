...
==== Session1_LovingKindnessOutline ====
    ...
    With this imagine in mind, you'll have to say softly to yourself the following three phrases:
    ...
    And then you'll repeat this process three times. Are you ready to try it out?
...
==== Second_session ====
Hi {username}, welcome back! Last time I showed you an exercise to practice kind self talk. I hope you had the chance to use it on your own.

Today, I want to show you how to apply this exercise in kindness to a stranger. Sometimes it is easier to practice kindness to those we don't know well. 
...
==== Session2_LovingKindnessOutline ====
    ...
    With this image in mind, say softly to them the following three phrases
...
==== Session2_LovingKindnessForStrangerStart ====
    ...
    Okay now bring the image of the person to mind. Picture them smiling at you and envision what they look like, what they're wearing.
...
==== EndSession2 ====
    ...
    +I feel calmer
        Great!
        Remember that it's a good practice to do this exercise daily. You can even start saying these phrases when you see any strangers as you go on in your life.
        
        Next time we meet we'll apply this exercise to someone you know that might be difficult to deal with. No need to stress about it now, we'll work on it next time together. See you soon!
        
        ->END
    +I feel happier
        Wonderful. Remember that it's a good practice to do this exercise daily. You can even start saying these phrases when you see any strangers as you go on in your life.
    ...
    +I feel the same
        No problem. Sometimes it takes a little bit of practice to start feeling those positive thoughts towards yourself and to others. 
        
        Try practicing this exercise over the course of the week and see if you start feeling more kindness towards others. You can even start saying these phrases when you see any strangers as you go on in your life.
...
==== Third_session ====
Hi again, {username}. I hope you are well and that you had a chance to practice saying those kind phrase to yourself and to others. 
Today's exercise will be about redirecting those positive thoughts to someone in your life that might be difficult to deal with. This can be hard to tackle, but we can try together. Are you ready to try it out?
...
==== Session3_LovingKindness ====
    ...
    Remember that this exercise is all about generating positive feelings towards ourselves and to others.
    
    For this session, we're going to focus on someone in your life. Loving others that are difficult to love is hard, but sometimes it is helpful and necessary for both you and them. 
...
==== Session3_LovingKindnessForDifficultStart ====
    ...
    Try to think about the person itself and not of what they did in the past. Picture them in comfortable setting, maybe smiling with their family or playing with their pet.
...
==== EndSession3 ====
    ...
    +I feel calmer
        ...
        You can remember to do this exercise regularly, picturing those that are difficult in your life.
        By now I think you've mastered this exercise and can use any version of it to practice kindness towards yourself and others. 
    ...
    +I feel the same
        No problem. Sending love to those that are difficult is a huge step and it might take more than once to get used to it.Try practicing this exercise over the course of the week and see if you start feeling more kindness towards others. Y

        By now I think you've mastered this exercise and can use any version of it to practice kindness towards yourself and others. Try using it regularly to see if you start feeling better.
